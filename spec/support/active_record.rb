...
class DropOtherMostRecentColumn < ActiveRecord::Migration
  def change
    remove_index :other_active_record_model_transitions,
                 name: "index_other_active_record_model_transitions_"\
                       "parent_most_recent"
    remove_column :other_active_record_model_transitions, :most_recent
  end
end
